...
export CROP_TYPE=SW
export CESM_CASE_NAME=clm5_${CLM_USRDAT_NAME}-all${CROP_TYPE}-`date "+%y%m%d"`-realSWparam-testNofertOnlyforMXG
...
ls ${INPUTDATA_DIR}/user_inputdata/${CLM_USRDAT_NAME}/surfdata_${CLM_USRDAT_NAME}_78pfts_CMIP6_simyr1850_${SURFFILE_CYYYYMMDD}_allCorn_180910.nc
ln -s ${INPUTDATA_DIR}/user_inputdata/${CLM_USRDAT_NAME}/surfdata_${CLM_USRDAT_NAME}_78pfts_CMIP6_simyr1850_${SURFFILE_CYYYYMMDD}_allSW_180910_real.nc ${CESM_INPUTDATA_DIR}/lnd/clm2/surfdata_map/surfdata_${CLM_USRDAT_NAME}_simyr${SIMYR}_all${CROP_TYPE}_real.nc
...
#++++ Start from spinup with dynlanduse
...
export paramfile=${param_dic}/clm5_params.c171117_real_Corn_SW_MXG_190227_rf0.55.nc
ls $paramfile
...
irrigate = .false.
use_fertilizer = .true.
flanduse_timeseries ='/pic/projects/landuq/chen693/IM3_CLM5/inputdata/user_inputdata/1x1_Illinois/landuse.timeseries_1x1_Illinois_hist_78pfts_CMIP6_simyr2009-2014_c181008_allSW_5.6_realSWid.nc'
